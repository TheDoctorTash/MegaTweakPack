...
procedure RegShellMenu(ShellExe: string);
const
  ActionCaptionsGUI: array [TAction] of string = ('Запросить разрешение',
    'С пониженными правами', 'С правами админа', 'Не переходить в спящий режим до выхода',
    'Не гасить экран', 'Заблокировать и уведомить', '', '',
